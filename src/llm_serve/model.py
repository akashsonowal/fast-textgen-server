...
from .app import LLMServe, ParallelLLMServe
from .utils import get_default_device

DEFAULT_MODEL = "meta-llama/Llama-2-7b-chat-hf"
ML_SERVE_PARALLEL_HANDLER = int(os.environ.get("ML_SERVE_PARALLEL_HANDLER", "0"))
MLServeMode = ParallelLLMServe if ML_SERVE_PARALLEL_HANDLER == 1 else LLMServe
...
class PromptRequest(BaseModel):
    ...
    authtoken: str = "79870be8ab3a7233e3ff8f636dec13e2"
    temperature: float = 1
    max_tokens: int = 1024
    stop: List[str] = []
...
class ServeLLama2(MLServeMode):
    def __init__(self, model_path=DEFAULT_MODEL, batch_size=1, timeout=0.0, auth_token="79870be8ab3a7233e3ff8f636dec13e2"):
        super().__init__(
            batch_size,
            timeout,
            auth_token,
